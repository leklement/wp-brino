...
<div class="p-5">
    ...
    <input type="submit" id="doaction" class="button action" value="Sync selected" class="mr-0">
            ...
            <tr>
                <td id="cb" class="manage-column column-cb check-column">
                  ...
                  <th scope="col" id="id" class="manage-column column-name column-primary sortable desc">
                    <a href="https://new.brino.sk/wp-admin/edit-tags.php?taxonomy=product_cat&amp;post_type=product&amp;orderby=name&amp;order=asc">
                ...
                <th scope="col" id="description" class="manage-column column-description sortable desc">
                    <a href="https://new.brino.sk/wp-admin/edit-tags.php?taxonomy=product_cat&amp;post_type=product&amp;orderby=description&amp;order=asc">
                        <span>Popis</span><span class="sorting-indicator"></span>
                    </a>
                    </th>
                <th scope="col" id="slug" class="manage-column column-slug sortable desc">
                    <a href="https://new.brino.sk/wp-admin/edit-tags.php?taxonomy=product_cat&amp;post_type=product&amp;orderby=slug&amp;order=asc">
            ...
            foreach ($all_categories as $cat) {
                if($cat->category_parent == 0) {
                    ...
                    <th scope="row" class="check-column">
                      ...
                      ><input type="checkbox" name="delete_tags[]" value="16" id="cb-select-16" />
                    </th>
