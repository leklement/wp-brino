...
<div class="p-5 mb-4 bg-light rounded-3">
    ...
    <form id="brino-sync-form__form" method="post" action="options.php">
        <?php
        ...
        <div class="form-group mb-2">
            ...
            <input type="text" value="<?php echo get_option('brinnoApikey'); ?>" name='brinnoApikey' placeholder="Brino's api key" class="form-control">
        </div>
